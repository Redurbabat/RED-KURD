...
import { sucheStatisch, beispieleStatisch } from './statisch.js'
import { arabischNachLatein } from './schrift.js'

const SPRACHEN = { deu: 'Deutsch', kur: 'Kurdisch', kmr: 'Kurmancî', ckb: 'Soranî', eng: 'Englisch', tur: 'Türkisch', zza: 'Zazakî' }
